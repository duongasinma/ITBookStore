<%-- 
    Document   : createBook
    Created on : May 24, 2021, 5:09:32 PM
    Author     : DUONGAS
--%>
                        ...
                        <form action="MainController">
                            <div class="col-sm-3">
                                <div class="shopper-info ">
                                    ...
                                    <a><input type="submit" class="btn btn-primary" value="create" name="btAction" /></a>
                            ...
                            <div class="col-sm-4">
                                <div class="order-message">
                                    <p>Description</p>
                                    <textarea name="txtDescription"  placeholder="Notes about your order, Special Notes for Delivery" rows="16"></textarea>
                                </div>	
                            </div>	
                        </form>
                    </div>
